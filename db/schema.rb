...
ActiveRecord::Schema.define(version: 2021_04_11_233413) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "carrinho_compras", force: :cascade do |t|
    t.bigint "produto_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["produto_id"], name: "index_carrinho_compras_on_produto_id"
    t.index ["user_id"], name: "index_carrinho_compras_on_user_id"
  end
  ...
  create_table "entregas", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["endereco_id"], name: "index_entregas_on_endereco_id"
  ...
  add_foreign_key "carrinho_compras", "produtos"
  add_foreign_key "carrinho_compras", "users"
  add_foreign_key "enderecos", "users"
  add_foreign_key "entregas", "enderecos"
